...
class VideoCal extends StatefulWidget {
  const VideoCal({Key? key}) : super(key: key);

  @override
  State<VideoCal> createState() => _VideoCalState();
}

class _VideoCalState extends State<VideoCal> {
  int? _remoteUid;
    ...
    if (_remoteUid != null) {
      return AgoraVideoView(
        controller: VideoViewController.remote(
          ...
          connection: const RtcConnection(channelId: appChannel),
        ),
      );
    } else {
      return const Text(

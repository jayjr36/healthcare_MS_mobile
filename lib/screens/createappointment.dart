...
class AppointmentMakingPage extends StatefulWidget {
  const AppointmentMakingPage({Key? key}) : super(key: key);

  @override
  State<AppointmentMakingPage> createState() => AppointmentMakingPageState();
}

class AppointmentMakingPageState extends State<AppointmentMakingPage> {
  ...
  // Ensure _focusDay is within the range
  //   if (_focusDay.isAfter(DateTime(2024, 05, 19))) {
  //     _focusDay = DateTime(2024, 05, 19);
  //   }
  // }
  ...
  Widget _tableCalendar() {
    ...
    DateTime lastDay = DateTime(
        firstDay.year + 1, firstDay.month, firstDay.day); // one year from now
